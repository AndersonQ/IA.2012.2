...
/*==================FHZ Editou a partir deste ponto para o Heurística Cidades==================*/

	/* apliquei o goggle maps a um subconjunto das cidades*/
	/* a distãncia de A até B é a mesma de B até A, logo a matriz se torna diagonal inf ou superior*/
	/* 8 cidades 1+2+...+7= 36, o mesmo número da prova HAHAHA*/
	...
	g.addEdge(ct1, ct1, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct2, ct1, new WeightCityDistantLink(g, 41.7) );
	g.addEdge(ct3, ct1, new WeightCityDistantLink(g, 43.2) );
	g.addEdge(ct4, ct1, new WeightCityDistantLink(g, 41.3) );
	g.addEdge(ct5, ct1, new WeightCityDistantLink(g, 59.7) );
	g.addEdge(ct6, ct1, new WeightCityDistantLink(g, 51.1) );
	g.addEdge(ct7, ct1, new WeightCityDistantLink(g, 37.7) );
	g.addEdge(ct8, ct1, new WeightCityDistantLink(g, 28.8) );

	g.addEdge(ct2, ct2, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct3, ct2, new WeightCityDistantLink(g, 38.8) );
	g.addEdge(ct4, ct2, new WeightCityDistantLink(g, 61.8) );
	g.addEdge(ct5, ct2, new WeightCityDistantLink(g, 32.5) );
	g.addEdge(ct6, ct2, new WeightCityDistantLink(g, 12.3) );
	g.addEdge(ct7, ct2, new WeightCityDistantLink(g, 22.1) );
	g.addEdge(ct8, ct2, new WeightCityDistantLink(g, 18.3) );

	g.addEdge(ct3, ct4, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct4, ct4, new WeightCityDistantLink(g, 45.2) );
	g.addEdge(ct5, ct4, new WeightCityDistantLink(g, 35. );
	g.addEdge(ct6, ct4, new WeightCityDistantLink(g, 36. );
	g.addEdge(ct7, ct4, new WeightCityDistantLink(g, 19.2) );
	g.addEdge(ct8, ct4, new WeightCityDistantLink(g, 44.2) );
	
	g.addEdge(ct4, ct4, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct5, ct4, new WeightCityDistantLink(g, 71.1) );
	g.addEdge(ct6, ct4, new WeightCityDistantLink(g, 70.4) );
	g.addEdge(ct7, ct4, new WeightCityDistantLink(g, 45.2) );
	g.addEdge(ct8, ct4, new WeightCityDistantLink(g, 52.2) );

	g.addEdge(ct5, ct5, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct6, ct5, new WeightCityDistantLink(g, 9.3) );
	g.addEdge(ct7, ct5, new WeightCityDistantLink(g, 28.7) );
	g.addEdge(ct8, ct5, new WeightCityDistantLink(g, 44.9) );

	g.addEdge(ct6, ct6, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct7, ct6, new WeightCityDistantLink(g, 20.2) );
	g.addEdge(ct8, ct6, new WeightCityDistantLink(g, 34,8) );

	g.addEdge(ct7, ct7, new WeightCityDistantLink(g, 0) );
	g.addEdge(ct8, ct7, new WeightCityDistantLink(g, 18.2) );

	g.addEdge(ct8, ct8, new WeightCityDistantLink(g, 0) );

	
	
/*==================FHZ Editou até este ponto para o Heurística Cidades==================*/
